...
namespace calaaaaa
{
    ...
    internal class Class1
    {
        public static void Main()
        {
            ...
            Console.WriteLine(SumExample(389));
            int[] i = { 1, 1, 1, 1, 11, 1 };
            Console.WriteLine(num_of_pairs(i, 12));
            Console.WriteLine(conv_str("Fired:Corwill;Wilfred:Corwill;Barney:TornBull;Betty:Tornbull;Bjon:Tornbull;Raphael:Corwill;Alfred:Corwill"));
        }
        ...
        {
            var exp = 3;
            Assert.AreEqual(exp, num_of_pairs(new int[] { 1, 1, 1 }, 2));

            exp = 0;
            Assert.AreEqual(exp, num_of_pairs(new int[] { 0, 0, 0, 0, 0, 2 }, 1));
        }
        [Test]
        public void verify_num_of_pairs_not_equal()
        {
            var expected_result = 2;
            Assert.AreNotEqual(expected_result, num_of_pairs(new int[] { 1, 1, 1 }, 2));
        }
        ...
        public void verify_conv_string_equal()
        {
            ...
            var ret = conv_str("Fired:Corwill;Wilfred:Corwill;Barney:TornBull;Betty:Tornbull;Bjon:Tornbull;Raphael:Corwill;Alfred:Corwill");
